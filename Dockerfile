...
RUN wget https://github.com/lh3/minimap2/archive/refs/tags/v${minimap2_version}.tar.gz 
...
RUN tar -zxvf v${minimap2_version}.tar.gz
...
WORKDIR /usr/local/samtools-${samtools_version}
RUN autoheader
